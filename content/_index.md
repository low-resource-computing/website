...
To attend, email [lrc-group@dartmouth.edu](mailto:lrc-group@dartmouth.edu) — see [Attend]({{< relref "attend.md" >}}) for details, [Agenda]({{< relref "agenda.md" >}}) for the schedule, [CFP]({{< relref "cfp.md" >}}) to propose a talk, and [Logistics]({{< relref "logistics.md" >}}) for travel and lodging.
